...
def highlight(text, syntax):
	if not syntax:
		...
		return text
#highlight('test 1234.5 0x16 test', 'rpt')

testrpt = Path(r'C:\Users\Terra\AppData\Local\Arma 3\arma3diag_x64_2020-12-02_01-05-29.rpt')
print(highlight(testrpt.read_text(), 'rpt'))